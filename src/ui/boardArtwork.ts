...
import boardArtworkUrl from '../assets/taiwan-adventure-board.png';

/**
 * Presentation coordinates for the formal board artwork.
 *
 * These percentages are deliberately kept outside BOARD_TILES and the game
 * engine.  They only describe where the live DOM nodes sit on the supplied
 * illustrated board (0..26 around the printed route, 27..29 in the offshore
 * vignette).
 */
...
export const BOARD_ARTWORK_ASSET_URL = boardArtworkUrl;
