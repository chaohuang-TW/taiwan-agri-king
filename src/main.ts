...
app.innerHTML = `
  ...
  <main id="top">
    <section class="hero" aria-labelledby="hero-title">
      <div class="hero-copy"><p class="eyebrow">Phase 3 開發預覽</p><h1 id="hero-title">《臺灣農產王》<span>環島產地爭霸戰</span></h1><p class="hero-subtitle">走臺灣，認產地，買農產，拚產值。</p><div class="hero-actions"><a class="primary-link" href="./game.html">開始遊戲</a><button type="button" data-open="rules-dialog">看規則</button></div></div>
